...
export const getRightSideColumns = (activeButton: number): RightColumn[] => {
    switch(activeButton) {
        ...
        case 13:
            ...
            // SA(X)	RAS	DUE	WNC	EXE	WHT	MMI	PAT	HAF	BIA	QRR	ESD	EOV	+	INJ	HDM	COM
            return [
                { column_id: 'col_13_1', label: 'SA(X)', width: '100px', align: 'right' },
                { column_id: 'col_13_2', label: 'RAS', width: '100px', align: 'right' },
                { column_id: 'col_13_3', label: 'DUE', width: '100px', align: 'right' },
                { column_id: 'col_13_4', label: 'WNC', width: '100px', align: 'right' },
                { column_id: 'col_13_5', label: 'EXE', width: '100px', align: 'right' },
                { column_id: 'col_13_6', label: 'WHT', width: '100px', align: 'right' },
                { column_id: 'col_13_7', label: 'MMI', width: '100px', align: 'right' },
                { column_id: 'col_13_8', label: 'PAT', width: '100px', align: 'right' },
                { column_id: 'col_13_9', label: 'HAF', width: '100px', align: 'right' },
                { column_id: 'col_13_10', label: 'BIA', width: '100px', align: 'right' },
                { column_id: 'col_13_11', label: 'QRR', width: '100px', align: 'right' },
                { column_id: 'col_13_12', label: 'ESD', width: '100px', align: 'right' },
                { column_id: 'col_13_13', label: 'EOV', width: '100px', align: 'right' },
                { column_id: 'col_13_14', label: '+', width: '100px', align: 'right' },
                { column_id: 'col_13_15', label: 'INJ', width: '100px', align: 'right' },
                { column_id: 'col_13_16', label: 'HDM', width: '100px', align: 'right' },
                { column_id: 'col_13_17', label: 'COM', width: '100px', align: 'right' },
            ];
