...
// type ClickState = 0 | 1 | 2 | 3; // 0 = default, 1 = first click, 2 = second click
...
//     <button
//       onClick={handleClick}
//       className={`runner-btn transition-all duration-200 ease-in-out text-[11pt] ${stateColors[clickState]}`}
//       style={
//         { 
